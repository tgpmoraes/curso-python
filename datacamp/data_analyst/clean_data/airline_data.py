airlines_columns = ['id', 'full_name', 'day', 'airline', 'destination',
                    'dest_region', 'dest_size', 'boarding_area', 'dept_time',
...
survey_columns = ['id', 'day', 'airline', 'destination', 'dest_region',
                  'dest_size', 'boarding_area', 'dept_time', 'wait_min',
                  'cleanliness', 'safety', 'satisfaction', 'survey_response']
