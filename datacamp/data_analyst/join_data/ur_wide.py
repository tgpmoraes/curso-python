...
ur_wide_cols = ['year', 'jan', 'feb', 'mar', 'apr', 'may', 'jun', 'jul', 'aug', 'sep', 'oct', 'nov', 'dec']

ur_wide = [['2010', 9.8, 9.8, 9.9, 9.9, 9.6, 9.4, 9.4, 9.5, 9.5, 9.4, 9.8, 9.3],
           ...
           ['2020', 3.6, 3.5, 4.4, NAN, NAN, NAN, NAN, NAN, NAN, NAN, NAN, NAN]]
